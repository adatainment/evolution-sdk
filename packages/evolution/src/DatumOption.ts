 ...
 * @category encoding
 */
export const toCBORBytes = (data: DatumOption, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
 ...
 * @category encoding
 */
export const toCBORHex = (data: DatumOption, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
