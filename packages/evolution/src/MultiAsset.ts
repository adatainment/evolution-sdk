 ...
 * @category encoding
 */
export const toCBORBytes = (data: MultiAsset, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
 ...
 * @category encoding
 */
export const toCBORHex = (data: MultiAsset, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
