 ...
 * @category encoding
 */
export const toCBORBytes = (procedure: ProposalProcedure, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
 ...
 * @category encoding
 */
export const toCBORHex = (procedure: ProposalProcedure, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
