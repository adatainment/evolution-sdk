 ...
 * @category encoding
 */
export const toCBORBytes = (data: ProposalProcedures, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
 ...
 * @category encoding
 */
export const toCBORHex = (data: ProposalProcedures, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
