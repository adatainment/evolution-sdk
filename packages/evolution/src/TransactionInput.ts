 ...
 * @category conversion
 */
export const toCBORBytes = (data: TransactionInput, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
 ...
 * @category conversion
 */
export const toCBORHex = (data: TransactionInput, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
