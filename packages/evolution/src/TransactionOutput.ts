 ...
 * @category encoding
 */
export const toCBORBytes = (data: TransactionOutput, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
 ...
 * @category encoding
 */
export const toCBORHex = (data: TransactionOutput, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
