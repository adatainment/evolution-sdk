 ...
 * @category encoding
 */
export const toCBORBytes = (vrfCert: VrfCert, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
 ...
 * @category encoding
 */
export const toCBORHex = (vrfCert: VrfCert, options: CBOR.CodecOptions = CBOR.PRESERVE_OPTIONS) =>
